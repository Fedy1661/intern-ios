...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Cams",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Cams11AppDelegate")
...
SWIFT_CLASS("_TtC4Cams7CamCell")
@interface CamCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified recording;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified favorite;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified snapshotImage;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC4Cams13DoorphoneCell")
@interface DoorphoneCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified subTitleLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified lock;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified favorite;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC4Cams12EntranceCell")
...
SWIFT_CLASS("_TtC4Cams13SceneDelegate")
...
SWIFT_CLASS("_TtC4Cams9TableView")
...
SWIFT_CLASS("_TtC4Cams14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified header;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified signifier;
@property (nonatomic, weak) IBOutlet TableView * _Null_unspecified tableView;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified signifierLeading;
- (void)viewDidLoad;
- (IBAction)didTapCameras:(id _Nonnull)sender;
- (IBAction)didTapDoors:(id _Nonnull)sender;
